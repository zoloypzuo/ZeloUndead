...
public class InventoryAudioPlayer : MonoBehaviour
{
    ...
    public static InventoryAudioPlayer instance {
    ...
    protected AudioCollection _stateNotificationSounds = null;

    // Events
    [Header("Event Listeners")] public InventoryAudioBeginEvent OnBeginAudio = new InventoryAudioBeginEvent();
