...
public enum InventoryWeaponType
{
    None,
    SingleHanded,
    TwoHanded
...
public enum InventoryWeaponFeedType
{
    None,
    Melee,
    Ammunition
...
public enum InventoryWeaponReloadType
{
    None,
    Partial,
    NonPartial
...
public class InventoryItem : ScriptableObject
{
    ...
    [Tooltip("Interactive Text that is display next to the item name.")] [SerializeField]
    protected string _pickupText = "Press 'Use' to Pickup";

    [Tooltip("Name used for displaying this item in the Inventory.")] [SerializeField]
    protected string _inventoryName = null;

    [Tooltip("Sprite used to display this item in the Inventory.")] [SerializeField]
    protected Sprite _inventoryImage = null;

    [Tooltip("What type of configurable Action does this item support.")] [SerializeField]
    protected InventoryAction _inventoryAction = InventoryAction.None;

    [Tooltip("UI Text that describes the action (used on Action Buttons in UI).")] [SerializeField]
    protected string _InventoryActionText = null;
    ...
    [SerializeField]
    protected CollectableItem _collectableItem = null;
    ...
    [Tooltip("The type of Inventory Item this is.")] [SerializeField]
    protected InventoryItemType _category = InventoryItemType.None;

    [Tooltip("Audio Collection to use for this Inventory Item.\n\n" +
             "Bank[0] : Pickup Sounds\nBank[1] : Drop Sounds\nBank[2] : Use Sounds")]
    [SerializeField]
    protected AudioCollection _audio = null;
    ...
    public virtual string pickupText {
        get { return _pickupText; }
    }

    public InventoryItemType category {
