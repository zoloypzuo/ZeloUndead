...
public enum InventoryItemWeaponShakeType {  OnFire, OnHit }
...
public class InventoryItemWeapon : InventoryItem
{
    ...
    [Range(0, 20)]
    [SerializeField] protected int _soundRadius = 1;
    ...
    [Tooltip("How much the condition of the weapon depletes wth each use")]
    [Range(0, 100)]
    [SerializeField] protected float _conditionDepletion = 1.0f;
    ...
    [SerializeField] protected InventoryItemWeaponShakeType _shakeType = InventoryItemWeaponShakeType.OnFire;

    [Tooltip("Duration of Shake Effect of this weapon")]
    [SerializeField] protected float _shakeDuration = 0.0f;

    [Tooltip("Magnitude of Shake Effect of this weapon")]
    [SerializeField] protected float _shakeMagnitude= 0.0f;

    [Tooltip("Damping of Shake Effect of this weapon")]
    [SerializeField] protected float _shakeDamping = 1.0f;

    [Tooltip("Dual Mode FOV")]
    [SerializeField] protected float _dualModeFOV = 45.0f;

    [Tooltip("Image used for weapon crosshair")]
    [SerializeField] protected Sprite _crosshair = null;
    ...
    public float    soundRadius                     { get { return _soundRadius; } }
    public float    conditionDepletion              { get { return _conditionDepletion; } }
    ...
    public int      attackAnimCount                    { get { return _attackAnimCount; } }
    public float    shakeDuration                      { get { return _shakeDuration; } }
    public float    shakeMagnitude                     { get { return _shakeMagnitude; } }
    public float    shakeDamping                       { get { return _shakeDamping; } }
    public float    dualModeFOV                        { get { return _dualModeFOV; } }
    public Sprite   crosshair                          { get { return _crosshair; } }
