...
public class InteractiveGenericSwitch : InteractiveItem
{
    ...
    [TextArea(3, 10)] [SerializeField] protected string _stateSetText = "";
    [TextArea(3, 10)] [SerializeField] protected string _ObjectActiveText = "";
        ...
        if (_activationSounds != null && _activated) {
            ...
            if (_audioSource != null && AudioManager.instance) {
                ...
                _audioSource.outputAudioMixerGroup =
                    AudioManager.instance.GetAudioGroupFromTrackName(_activationSounds.audioGroup);
                _audioSource.Play();
            }
        }
