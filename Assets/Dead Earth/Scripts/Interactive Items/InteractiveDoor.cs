...
public class InteractiveDoor : InteractiveItem
{
    ...
    [Header("Events")]
    [Tooltip("Raised when the door state changes from Open to Closed or vica versa.")]
    ...
    public bool isAutoOpen                      { get { return _autoOpen; } }
    public AIInteractiveDoorType aiDoorType     { get { return _aiDoorType; } }
    public int  AIID = -1;
    ...
    // --------------------------------------------------------------------------------------------
    private IEnumerator Activate(bool frontSide, bool autoClosing = false, float delay = 0.0f, bool skipStartTime = false)
    {
        AudioClip clip = null;
