...
public class IKProceduralStepSystemDataEditor : Editor
{
    ...
    void OnEnable() {
        ...
        if (!_logo)
            _logo = (Texture2D) EditorGUIUtility.Load("Procedural IK Step System/Procedural IK Step System Logo.png");
    }
    ...
    public override void OnInspectorGUI() {
        ...
        IKStepSystemType t =
            (IKStepSystemType) EditorGUILayout.EnumPopup(_script.GetIKType(IKStepSystemDirection.down));
        ...
        _stepDownPelvisAdjustmentSpeed.floatValue =
            EditorGUILayout.FloatField(_stepDownPelvisAdjustmentSpeed.floatValue);
        EditorGUILayout.EndHorizontal();
